...
export const V3SelectValue: InjectionKey<Ref<string | number>> = Symbol(
  "V3SelectValue"
);
export const V3UpdateSelectValue: InjectionKey<(
  val: string | number
) => void> = Symbol("V3UpdateSelectValue");
...
export default {
  ...
  setup(props, context) {
    ...
    provide(V3SelectValue, selectValue);
    provide(V3UpdateSelectValue, updateSelectValue);
